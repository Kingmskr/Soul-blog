...
export const YoutubeIcon = ({ className, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42} // You can adjust the width and height as needed
      height={43}
      viewBox="0 0 44 43" // Adjusted viewBox for better centering
      className={cx("w-full h-auto", className)}
      {...rest}
    >
      <path
        fill="#FF0000" // YouTube's signature red color
        d="M21 1.5C10.64 1.5 1.5 10.64 1.5 21c0 10.36 9.14 19.5 19.5 19.5 10.36 0 19.5-9.14 19.5-19.5C40.5 10.64 31.36 1.5 21 1.5zM17 30.75V17.25L29.25 24z"
      />
    </svg>
  );
};
